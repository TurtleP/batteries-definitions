...
---@param position batteries.vector2 The circle's position
---@param radius number The circle's radius
---@param point batteries.vector2 The point to check
...
---@param a_position batteries.vector2 The first circle's position
---@param a_radius number The first circle's radius
---@param b_position batteries.vector2 The second circle's position
...
---@param a_position batteries.vector2 The circle's position
---@param a_radius number The circle's radius
---@param point batteries.vector2 The point to check
---@param separation? batteries.vector2 The separation distance between the circle and point (default `batteries.vector2(0)`)
...
---@param b_position batteries.vector2 The second circle's position
---@param b_radius number The second circle's radius
---@param separation? batteries.vector2 The separation distance between the circles (default `batteries.vector2(0)`)
...
---@param line_start batteries.vector2 The start point on the line segment
---@param line_end batteries.vector2 The ending point on the line segment
---@param point batteries.vector2 The point to reference
---@param separation? batteries.vector2 The separation distance between the points (default `batteries.vector2(0)`)
---@return batteries.vector2 closest The nearest point on the line from the reference point
...
---@param position batteries.vector2 The circle's position
---@param radius number The circle's radius
---@param separation? batteries.vector2 The separation distance between the line and circle (default `batteries.vector2(0)`)
...
---@param a_start batteries.vector2 The start point on the first line segment
---@param a_end batteries.vector2 The end point on the first line segment
---@param a_radius number The line radius of the first line segment
---@param b_start batteries.vector2 The start point on the second line segment
---@param b_end batteries.vector2 The end point on the second line segment
---@param b_radius number The line radius of the second line segment
---@param separation? batteries.vector2 The separation distance between the lines (default `batteries.vector2(0)`)
...
---@param position batteries.vector2 Center position of the box
---@param half_size batteries.vector2 Half-size dimensions of the box
---@param point batteries.vector2 The point to check
...
---@param half_size batteries.vector2 Half-size dimensions of the box
---@param point batteries.vector2 The point to check
---@param separation? batteries.vector2 The separation distance between the bounding box and point (default `batteries.vector2(0)`)
...
---@param a_position batteries.vector2 Center position of the first bounding box
---@param a_half_size batteries.vector2 Half-size dimensions of the first bounding box
---@param b_position batteries.vector2 Center position of the second bounding box
---@param b_half_size batteries.vector2 Half-size dimensions of the second bounding box
...
---@param point batteries.vector2 The point to check
---@param separation? batteries.vector2 The separation distance between the bounding box and point (default `batteries.vector2(0)`)
---@return batteries.vector2 clamped_point The clamped point
...
---@param position batteries.vector2 Center position of the box
---@param half_size batteries.vector2 Half-size dimensions of the box
---@param circle_position batteries.vector2 The position of the circle
---@param radius number The circle's radius
...
---@return batteries.vector2 position The center position of the bounding box
---@return batteries.vector2 half_size The half-size of the bounding box
...
---@param point batteries.vector2 The point to check
---@param polygon batteries.vector2[] List of batteries.vectors for the polygon
...
---@param result batteries.vector2
---@return batteries.vector2? result
...
---@param position batteries.vector2 The circle's position
---@param radius number The circle's radius
---@param box_position batteries.vector2 Center position of the box
---@param half_size batteries.vector2 Half-size dimensions of the box
...
---@param position batteries.vector2 The circle's position
---@param radius number The circle's radius
---@param line_start batteries.vector2 The line's start point
---@param line_end batteries.vector2 The line's end point
...
---@param a_position batteries.vector2 The first body position
---@param b_position batteries.vector2 The second body position
---@param separation? batteries.vector2 The separation distance between the two bodies (default `batteries.vector2(0)`)
...
---@param velocity batteries.vector2 The velocity
---@param normal batteries.vector2 The normalized vector
...
---@param velocity_a batteries.vector2 The first velocity vector
---@param velocity_b batteries.vector2 The second velocity vector
---@param normal batteries.vector2 The normalized vector
---@param conservation? number The dampening of the velocity (default `1`)
